...
An alternative approach is to set `MANUAL_CONFIGURATION: "True"` in
`docker-compose.yml`.  If you do that, you can provide a
`settings.py` file and a `zulip-secrets.conf` file in
