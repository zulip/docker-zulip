...
0. (Optional) Upgrading does not delete your data, but it's generally good
   ...
   switching back to the old version simple. You can find your docker data
   volumes by looking at the `volumes` lines in `docker-compose.yml`
...
[backups]: https://zulip.readthedocs.io/en/latest/production/export-and-import.html#backup-details
