...
![Version: 0.7.3](https://img.shields.io/badge/Version-0.7.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 7.3-0](https://img.shields.io/badge/AppVersion-7.3--0-informational?style=flat-square)
...
| image.tag | string | `"7.3-0"` | Zulip image tag (immutable tags are recommended) |
