...
![Version: 0.8.4](https://img.shields.io/badge/Version-0.8.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 8.4-0](https://img.shields.io/badge/AppVersion-8.4--0-informational?style=flat-square)
...
| image.tag | string | `"8.4-0"` | Zulip image tag (immutable tags are recommended) |
