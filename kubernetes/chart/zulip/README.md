...
![Version: 0.3.0](https://img.shields.io/badge/Version-0.3.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 5.5-0](https://img.shields.io/badge/AppVersion-5.5--0-informational?style=flat-square)
...
| image.tag | string | `"5.5-0"` | Zulip image tag (immutable tags are recommended) |
